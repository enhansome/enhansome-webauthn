...
* [MasterKale: SimpleWebAuthn Demo](https://example.simplewebauthn.dev) - A working instance of the [SimpleWebAuthn example project](https://github.com/MasterKale/SimpleWebAuthn/tree/master/example) ⭐ 2,350 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-13 showcasing both its server and browser libraries.
* [Anders Åberg: .NET library for FIDO2 Demo](https://github.com/abergs/fido2-net-lib) ⭐ 1,452 | 🐛 20 | 🌐 C# | 📅 2026-09-20 - A working implementation library + demo for FIDO2 and WebAuthn using .NET <https://fido2-net-lib.passwordless.dev/>.
...
* `FIDO CONFORMANT` [MasterKale: @simplewebauthn/server](https://github.com/MasterKale/SimpleWebAuthn) ⭐ 2,350 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-13 - WebAuthn, Simplified. A TypeScript-first Node.js library for simpler WebAuthn integration. Supports use in TypeScript and JavaScript projects. Partner library to the front end **@simplewebauthn/browser** (see [Client Libs](#client-libs)).
* `FIDO CONFORMANT` [Anders Åberg: .NET library for FIDO2](https://github.com/abergs/fido2-net-lib) ⭐ 1,452 | 🐛 20 | 🌐 C# | 📅 2026-09-20 - A working implementation library + demo for fido2 and WebAuthn using .NET.
...
* [kanidm: webauthn-rs](https://github.com/kanidm/webauthn-rs) ⭐ 709 | 🐛 35 | 🌐 Rust | 📅 2026-09-21 - An implementation of webauthn components for Rustlang servers.
...
* [Yubico: Java WebAuthn Server](https://github.com/Yubico/java-webauthn-server) ⭐ 563 | 🐛 21 | 🌐 Scala | 📅 2026-09-21 - Server-side Web Authentication library for Java.
...
* [MasterKale: @simplewebauthn/browser](https://github.com/MasterKale/SimpleWebAuthn/tree/master/packages/browser) ⭐ 2,350 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-13 - WebAuthn, Simplified. A TypeScript-first browser library for simpler WebAuthn integration. Supports use in TypeScript and JavaScript projects. Partner library to the back end **@simplewebauthn/server** (see [Server Libs](#server-libs)). Also works with Duo's py\_webauthn.
...
* [Yubico: Mobile Android SDK (YubiKit)](https://github.com/Yubico/yubikit-android) ⭐ 158 | 🐛 16 | 🌐 Java | 📅 2026-09-17 - YubiKit is an Android library provided by Yubico to interact with YubiKeys on Android devices. Works with other FIDO2 devices as well.
...
* [Pol Henarejos: pico-fido](https://github.com/polhenarejos/pico-fido) ⭐ 1,514 | 🐛 62 | 🌐 C | 📅 2026-09-20 - This project transforms your Raspberry Pi Pico into an integrated FIDO Passkey, functioning like a standard USB Passkey for authentication
* [bulwarkid: virtual-fido](https://github.com/bulwarkid/virtual-fido) ⭐ 1,402 | 🐛 36 | 🌐 C | 📅 2024-08-01 - virtual-fido is an Golang based commandline application which emulates an USB security token. This can also be used as a library.
...
* `FIDO CONFORMANT` [TheMaxMur: RS-Key](https://github.com/TheMaxMur/RS-Key) ⭐ 507 | 🐛 11 | 🌐 Rust | 📅 2026-09-20 - FIDO2/WebAuthn and U2F security-key firmware for the RP2350, written in Rust with reproducible builds; also implements OpenPGP, PIV and OATH.
...
* [WebAuthn Wiki](https://github.com/w3c/webauthn/wiki) ⭐ 1,462 | 🐛 111 | 🌐 Bikeshed | 📅 2026-09-18 - WebAuthn API spec official explainers and wiki
