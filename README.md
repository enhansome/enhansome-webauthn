...
* [MasterKale: SimpleWebAuthn Demo](https://example.simplewebauthn.dev) - A working instance of the [SimpleWebAuthn example project](https://github.com/MasterKale/SimpleWebAuthn/tree/master/example) ⭐ 2,326 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-05 showcasing both its server and browser libraries.
...
* `FIDO CONFORMANT` [WebAuthn Go library](https://github.com/go-webauthn/webauthn) ⭐ 1,329 | 🐛 10 | 🌐 Go | 📅 2026-09-05 - WebAuthn library written in Go (replaces the archived and deprecated [DUO: WebAuthn Go library](https://github.com/duo-labs/webauthn) ⚠️ Archived).
...
* [Yubico: Java WebAuthn Server](https://github.com/Yubico/java-webauthn-server) ⭐ 561 | 🐛 24 | 🌐 Scala | 📅 2026-09-04 - Server-side Web Authentication library for Java.
...
* [SharpLab: Spring-Security-WebAuthn](https://github.com/sharplab/spring-security-webauthn) ⭐ 225 | 🐛 1 | 🌐 Java | 📅 2026-09-07 - Unofficial WebAuthn module for the Spring Security project.
...
* [Yubico: Mobile Android SDK (YubiKit)](https://github.com/Yubico/yubikit-android) ⭐ 157 | 🐛 14 | 🌐 Java | 📅 2026-09-04 - YubiKit is an Android library provided by Yubico to interact with YubiKeys on Android devices. Works with other FIDO2 devices as well.
...
* [Pol Henarejos: pico-fido](https://github.com/polhenarejos/pico-fido) ⭐ 1,481 | 🐛 61 | 🌐 C | 📅 2026-09-07 - This project transforms your Raspberry Pi Pico into an integrated FIDO Passkey, functioning like a standard USB Passkey for authentication
...
* `FIDO CONFORMANT` [TheMaxMur: RS-Key](https://github.com/TheMaxMur/RS-Key) ⭐ 469 | 🐛 11 | 🌐 Rust | 📅 2026-09-04 - FIDO2/WebAuthn and U2F security-key firmware for the RP2350, written in Rust with reproducible builds; also implements OpenPGP, PIV and OATH.
...
* [WebAuthn Wiki](https://github.com/w3c/webauthn/wiki) ⭐ 1,450 | 🐛 112 | 🌐 HTML | 📅 2026-09-03 - WebAuthn API spec official explainers and wiki
