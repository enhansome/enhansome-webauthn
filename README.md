...
* [MasterKale: SimpleWebAuthn Demo](https://example.simplewebauthn.dev) - A working instance of the [SimpleWebAuthn example project](https://github.com/MasterKale/SimpleWebAuthn/tree/master/example) ⭐ 2,317 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-02 showcasing both its server and browser libraries.
...
* `FIDO CONFORMANT` [MasterKale: @simplewebauthn/server](https://github.com/MasterKale/SimpleWebAuthn) ⭐ 2,317 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-02 - WebAuthn, Simplified. A TypeScript-first Node.js library for simpler WebAuthn integration. Supports use in TypeScript and JavaScript projects. Partner library to the front end **@simplewebauthn/browser** (see [Client Libs](#client-libs)).
...
* `FIDO CONFORMANT` [WebAuthn Go library](https://github.com/go-webauthn/webauthn) ⭐ 1,325 | 🐛 10 | 🌐 Go | 📅 2026-09-02 - WebAuthn library written in Go (replaces the archived and deprecated [DUO: WebAuthn Go library](https://github.com/duo-labs/webauthn) ⚠️ Archived).
...
* [kanidm: webauthn-rs](https://github.com/kanidm/webauthn-rs) ⭐ 703 | 🐛 33 | 🌐 Rust | 📅 2026-08-19 - An implementation of webauthn components for Rustlang servers.
...
* [Yubico: Java WebAuthn Server](https://github.com/Yubico/java-webauthn-server) ⭐ 561 | 🐛 21 | 🌐 Scala | 📅 2026-08-31 - Server-side Web Authentication library for Java.
...
* [MasterKale: @simplewebauthn/browser](https://github.com/MasterKale/SimpleWebAuthn/tree/master/packages/browser) ⭐ 2,317 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-02 - WebAuthn, Simplified. A TypeScript-first browser library for simpler WebAuthn integration. Supports use in TypeScript and JavaScript projects. Partner library to the back end **@simplewebauthn/server** (see [Server Libs](#server-libs)). Also works with Duo's py\_webauthn.
...
* [Yubico: Mobile Android SDK (YubiKit)](https://github.com/Yubico/yubikit-android) ⭐ 157 | 🐛 15 | 🌐 Java | 📅 2026-09-01 - YubiKit is an Android library provided by Yubico to interact with YubiKeys on Android devices. Works with other FIDO2 devices as well.
...
* [Pol Henarejos: pico-fido](https://github.com/polhenarejos/pico-fido) ⭐ 1,465 | 🐛 59 | 🌐 C | 📅 2026-08-31 - This project transforms your Raspberry Pi Pico into an integrated FIDO Passkey, functioning like a standard USB Passkey for authentication
* [bulwarkid: virtual-fido](https://github.com/bulwarkid/virtual-fido) ⭐ 1,393 | 🐛 36 | 🌐 C | 📅 2024-08-01 - virtual-fido is an Golang based commandline application which emulates an USB security token. This can also be used as a library.
...
* `FIDO CONFORMANT` [TheMaxMur: RS-Key](https://github.com/TheMaxMur/RS-Key) ⭐ 454 | 🐛 10 | 🌐 Rust | 📅 2026-08-31 - FIDO2/WebAuthn and U2F security-key firmware for the RP2350, written in Rust with reproducible builds; also implements OpenPGP, PIV and OATH.
...
* [WebAuthn Wiki](https://github.com/w3c/webauthn/wiki) ⭐ 1,438 | 🐛 110 | 🌐 HTML | 📅 2026-08-31 - WebAuthn API spec official explainers and wiki
