...
* [MasterKale: SimpleWebAuthn Demo](https://example.simplewebauthn.dev) - A working instance of the [SimpleWebAuthn example project](https://github.com/MasterKale/SimpleWebAuthn/tree/master/example) ⭐ 2,344 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-13 showcasing both its server and browser libraries.
* [Anders Åberg: .NET library for FIDO2 Demo](https://github.com/abergs/fido2-net-lib) ⭐ 1,451 | 🐛 36 | 🌐 C# | 📅 2026-09-12 - A working implementation library + demo for FIDO2 and WebAuthn using .NET <https://fido2-net-lib.passwordless.dev/>.
...
* `FIDO CONFORMANT` [MasterKale: @simplewebauthn/server](https://github.com/MasterKale/SimpleWebAuthn) ⭐ 2,344 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-13 - WebAuthn, Simplified. A TypeScript-first Node.js library for simpler WebAuthn integration. Supports use in TypeScript and JavaScript projects. Partner library to the front end **@simplewebauthn/browser** (see [Client Libs](#client-libs)).
* `FIDO CONFORMANT` [Anders Åberg: .NET library for FIDO2](https://github.com/abergs/fido2-net-lib) ⭐ 1,451 | 🐛 36 | 🌐 C# | 📅 2026-09-12 - A working implementation library + demo for fido2 and WebAuthn using .NET.
* `FIDO CONFORMANT` [WebAuthn Go library](https://github.com/go-webauthn/webauthn) ⭐ 1,333 | 🐛 7 | 🌐 Go | 📅 2026-09-10 - WebAuthn library written in Go (replaces the archived and deprecated [DUO: WebAuthn Go library](https://github.com/duo-labs/webauthn) ⚠️ Archived).
...
* `FIDO CONFORMANT` [cedarcode: WebAuthn Ruby](https://github.com/cedarcode/webauthn-ruby) ⭐ 773 | 🐛 12 | 🌐 Ruby | 📅 2026-09-03 - Ruby implementation of a WebAuthn Relying Party.
* [kanidm: webauthn-rs](https://github.com/kanidm/webauthn-rs) ⭐ 706 | 🐛 34 | 🌐 Rust | 📅 2026-08-19 - An implementation of webauthn components for Rustlang servers.
...
* `FIDO CONFORMANT` [WebAuthn4J Project: WebAuthn4J](https://github.com/webauthn4j/webauthn4j) ⭐ 590 | 🐛 16 | 🌐 Java | 📅 2026-09-02 - A portable Java library for WebAuthn server side verification.
...
* [Yubico: Java WebAuthn Server](https://github.com/Yubico/java-webauthn-server) ⭐ 562 | 🐛 24 | 🌐 Scala | 📅 2026-09-10 - Server-side Web Authentication library for Java.
...
* [SharpLab: Spring-Security-WebAuthn](https://github.com/sharplab/spring-security-webauthn) ⭐ 224 | 🐛 1 | 🌐 Java | 📅 2026-09-08 - Unofficial WebAuthn module for the Spring Security project.
...
* `FIDO CONFORMANT` [Eclipse Vert.x: WebAuthn](https://github.com/eclipse-vertx/vertx-auth) ⭐ 175 | 🐛 48 | 🌐 Java | 📅 2026-09-10 - Reactive WebAuthn library for Eclipse Vert.x. Works with any Vert.x related framework: Vert.x Web, Quarkus, ES4X, etc.
* `FIDO CERTIFIED™` [Hanko: Passkey Server](https://github.com/teamhanko/passkeys) ⭐ 170 | 🐛 10 | 🌐 Go | 📅 2026-08-12 - FIDO2-certified passkey & WebAuthn server written in Go. Includes a JavaScript client SDK and a passkey provider for Auth.js (Next-Auth).
...
* [MasterKale: @simplewebauthn/browser](https://github.com/MasterKale/SimpleWebAuthn/tree/master/packages/browser) ⭐ 2,344 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-13 - WebAuthn, Simplified. A TypeScript-first browser library for simpler WebAuthn integration. Supports use in TypeScript and JavaScript projects. Partner library to the back end **@simplewebauthn/server** (see [Server Libs](#server-libs)). Also works with Duo's py\_webauthn.
...
* [Corbado: flutter-passkeys](https://github.com/corbado/flutter-passkeys/) ⭐ 186 | 🐛 8 | 🌐 Dart | 📅 2026-09-11 - Flutter package to provide passkey authentication for iOS and Android apps.
* [Yubico: Mobile Android SDK (YubiKit)](https://github.com/Yubico/yubikit-android) ⭐ 157 | 🐛 14 | 🌐 Java | 📅 2026-09-08 - YubiKit is an Android library provided by Yubico to interact with YubiKeys on Android devices. Works with other FIDO2 devices as well.
...
* [Pol Henarejos: pico-fido](https://github.com/polhenarejos/pico-fido) ⭐ 1,494 | 🐛 62 | 🌐 C | 📅 2026-09-10 - This project transforms your Raspberry Pi Pico into an integrated FIDO Passkey, functioning like a standard USB Passkey for authentication
...
* `FIDO CONFORMANT` [TheMaxMur: RS-Key](https://github.com/TheMaxMur/RS-Key) ⭐ 488 | 🐛 13 | 🌐 Rust | 📅 2026-09-08 - FIDO2/WebAuthn and U2F security-key firmware for the RP2350, written in Rust with reproducible builds; also implements OpenPGP, PIV and OATH.
...
* [Google: OpenSK](https://github.com/google/OpenSK) ⭐ 3,423 | 🐛 12 | 🌐 Rust | 📅 2026-09-04 - OpenSK is an open-source implementation for security keys written in Rust that supports both FIDO U2F and FIDO2 standards.
...
* [WebAuthn Wiki](https://github.com/w3c/webauthn/wiki) ⭐ 1,457 | 🐛 112 | 🌐 Bikeshed | 📅 2026-09-10 - WebAuthn API spec official explainers and wiki
