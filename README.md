...
* `FIDO CONFORMANT` [WebAuthn4J Project: WebAuthn4J](https://github.com/webauthn4j/webauthn4j) ⭐ 585 | 🐛 14 | 🌐 Java | 📅 2026-08-17 - A portable Java library for WebAuthn server side verification.
...
* [Corbado: flutter-passkeys](https://github.com/corbado/flutter-passkeys/) ⭐ 185 | 🐛 2 | 🌐 Dart | 📅 2026-08-17 - Flutter package to provide passkey authentication for iOS and Android apps.
...
* [Pol Henarejos: pico-fido](https://github.com/polhenarejos/pico-fido) ⭐ 1,406 | 🐛 57 | 🌐 C | 📅 2026-08-17 - This project transforms your Raspberry Pi Pico into an integrated FIDO Passkey, functioning like a standard USB Passkey for authentication
...
* [Peter Sanford: TPM FIDO](https://github.com/psanford/tpm-fido) ⭐ 382 | 🐛 28 | 🌐 Go | 📅 2024-05-11 - tpm-fido is FIDO token implementation for Linux that protects the token keys by using your system's TPM.
* `FIDO CONFORMANT` [TheMaxMur: RS-Key](https://github.com/TheMaxMur/RS-Key) ⭐ 378 | 🐛 4 | 🌐 Rust | 📅 2026-08-15 - FIDO2/WebAuthn and U2F security-key firmware for the RP2350, written in Rust with reproducible builds; also implements OpenPGP, PIV and OATH.
...
* [WebAuthn Wiki](https://github.com/w3c/webauthn/wiki) ⭐ 1,434 | 🐛 106 | 🌐 HTML | 📅 2026-08-06 - WebAuthn API spec official explainers and wiki
