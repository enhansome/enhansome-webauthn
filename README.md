...
* [MasterKale: SimpleWebAuthn Demo](https://example.simplewebauthn.dev) - A working instance of the [SimpleWebAuthn example project](https://github.com/MasterKale/SimpleWebAuthn/tree/master/example) ⭐ 2,310 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-14 showcasing both its server and browser libraries.
...
* [Spomky-Labs: Webauthn Demo](http://webauthn.spomky-labs.com) - a demo based on Symfony and the PHP framework [web-auth/webauthn-framework](https://github.com/web-auth/webauthn-framework) ⭐ 516 | 🐛 10 | 🌐 PHP | 📅 2026-08-01.
...
* `FIDO CONFORMANT` [MasterKale: @simplewebauthn/server](https://github.com/MasterKale/SimpleWebAuthn) ⭐ 2,310 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-14 - WebAuthn, Simplified. A TypeScript-first Node.js library for simpler WebAuthn integration. Supports use in TypeScript and JavaScript projects. Partner library to the front end **@simplewebauthn/browser** (see [Client Libs](#client-libs)).
...
* `FIDO CONFORMANT` [WebAuthn Go library](https://github.com/go-webauthn/webauthn) ⭐ 1,311 | 🐛 12 | 🌐 Go | 📅 2026-08-16 - WebAuthn library written in Go (replaces the archived and deprecated [DUO: WebAuthn Go library](https://github.com/duo-labs/webauthn) ⚠️ Archived).
* [Duo: py\_webauthn](https://github.com/duo-labs/py_webauthn) ⭐ 1,056 | 🐛 0 | 🌐 Python | 📅 2026-06-29 - Pythonic WebAuthn. A Python3 implementation of the WebAuthn API focused on making it easy to leverage the power of WebAuthn.
...
* [kanidm: webauthn-rs](https://github.com/kanidm/webauthn-rs) ⭐ 698 | 🐛 30 | 🌐 Rust | 📅 2026-07-30 - An implementation of webauthn components for Rustlang servers.
...
* `FIDO CONFORMANT` [WebAuthn4J Project: WebAuthn4J](https://github.com/webauthn4j/webauthn4j) ⭐ 585 | 🐛 15 | 🌐 Java | 📅 2026-08-14 - A portable Java library for WebAuthn server side verification.
...
* [Yubico: Java WebAuthn Server](https://github.com/Yubico/java-webauthn-server) ⭐ 561 | 🐛 24 | 🌐 Scala | 📅 2026-08-14 - Server-side Web Authentication library for Java.
* [Yubico: python-fido2](https://github.com/Yubico/python-fido2) ⭐ 543 | 🐛 31 | 🌐 Python | 📅 2026-06-29 - FIDO2 Client and Server lib.
* `FIDO CONFORMANT` [Spomky-Labs: WebAuthn Framework](https://github.com/web-auth/webauthn-framework) ⭐ 516 | 🐛 10 | 🌐 PHP | 📅 2026-08-01 - This framework contains PHP libraries and Symfony bundle to allow developpers to integrate FIDO2 authentication mechanism into their web applications.
...
* [Tangui: Wax](https://github.com/tanguilp/wax) ⭐ 231 | 🐛 8 | 🌐 Elixir | 📅 2026-04-07 - Elixir implementation of WebAuthn.
...
* [MasterKale: @simplewebauthn/browser](https://github.com/MasterKale/SimpleWebAuthn/tree/master/packages/browser) ⭐ 2,310 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-14 - WebAuthn, Simplified. A TypeScript-first browser library for simpler WebAuthn integration. Supports use in TypeScript and JavaScript projects. Partner library to the back end **@simplewebauthn/server** (see [Server Libs](#server-libs)). Also works with Duo's py\_webauthn.
* [Yubico: libfido2](https://github.com/Yubico/libfido2) ⭐ 726 | 🐛 18 | 🌐 C | 📅 2026-07-17 - C client library and command-line tools to communicate with a FIDO device over USB, and to verify attestation and assertion signatures.
...
* [Mozilla: authenticator-rs](https://github.com/mozilla/authenticator-rs/) ⭐ 314 | 🐛 58 | 🌐 Rust | 📅 2026-08-13 - Rust library to interact with Security Keys, used by Firefox.
...
* [Corbado: flutter-passkeys](https://github.com/corbado/flutter-passkeys/) ⭐ 185 | 🐛 5 | 🌐 Dart | 📅 2026-08-06 - Flutter package to provide passkey authentication for iOS and Android apps.
* [Yubico: Mobile Android SDK (YubiKit)](https://github.com/Yubico/yubikit-android) ⭐ 157 | 🐛 14 | 🌐 Java | 📅 2026-08-10 - YubiKit is an Android library provided by Yubico to interact with YubiKeys on Android devices. Works with other FIDO2 devices as well.
...
* [keys.pub: go-libfido2](https://github.com/keys-pub/go-libfido2) ⭐ 85 | 🐛 7 | 🌐 C | 📅 2025-10-21 - Go client library (wraps Yubico: libfido2).
* [COTECH: Hardware Security SDK](https://github.com/cotechde/hwsecurity) ⭐ 77 | 🐛 5 | 🌐 Java | 📅 2025-08-22 - Android library to interact with FIDO2 and U2F security keys over NFC and USB. Also provides a WebAuthn-WebView bridge.
...
* [Pol Henarejos: pico-fido](https://github.com/polhenarejos/pico-fido) ⭐ 1,406 | 🐛 57 | 🌐 C | 📅 2026-08-16 - This project transforms your Raspberry Pi Pico into an integrated FIDO Passkey, functioning like a standard USB Passkey for authentication
* [bulwarkid: virtual-fido](https://github.com/bulwarkid/virtual-fido) ⭐ 1,386 | 🐛 36 | 🌐 C | 📅 2024-08-01 - virtual-fido is an Golang based commandline application which emulates an USB security token. This can also be used as a library.
...
* [Peter Sanford: TPM FIDO](https://github.com/psanford/tpm-fido) ⭐ 381 | 🐛 28 | 🌐 Go | 📅 2024-05-11 - tpm-fido is FIDO token implementation for Linux that protects the token keys by using your system's TPM.
* `FIDO CONFORMANT` [TheMaxMur: RS-Key](https://github.com/TheMaxMur/RS-Key) ⭐ 375 | 🐛 4 | 🌐 Rust | 📅 2026-08-15 - FIDO2/WebAuthn and U2F security-key firmware for the RP2350, written in Rust with reproducible builds; also implements OpenPGP, PIV and OATH.
...
* [Fabian Henneke: WearAuthn](https://github.com/FabianHenneke/WearAuthn) ⭐ 267 | 🐛 20 | 🌐 Kotlin | 📅 2025-01-04 - FIDO2 Bluetooth HID/NFC soft token for Wear OS watches with support for resident keys.
...
* [Scott Leggett: PIV Agent](https://github.com/smlx/piv-agent) ⭐ 107 | 🐛 3 | 🌐 Go | 📅 2026-08-01 - An SSH and GPG agent which you can use with your PIV hardware security device (e.g. a Yubikey).
...
* [Google: OpenSK](https://github.com/google/OpenSK) ⭐ 3,398 | 🐛 12 | 🌐 Rust | 📅 2026-08-06 - OpenSK is an open-source implementation for security keys written in Rust that supports both FIDO U2F and FIDO2 standards.
...
* [BryanJacobs: FIDO2Applet](https://github.com/BryanJacobs/FIDO2Applet) ⭐ 157 | 🐛 0 | 🌐 Java | 📅 2026-08-01 - FIDO2 CTAP2 Javacard Applet.
...
* [WebAuthn Wiki](https://github.com/w3c/webauthn/wiki) ⭐ 1,432 | 🐛 106 | 🌐 HTML | 📅 2026-08-06 - WebAuthn API spec official explainers and wiki
