...
* [MasterKale: SimpleWebAuthn Demo](https://example.simplewebauthn.dev) - A working instance of the [SimpleWebAuthn example project](https://github.com/MasterKale/SimpleWebAuthn/tree/master/example) ⭐ 2,352 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-13 showcasing both its server and browser libraries.
* [Anders Åberg: .NET library for FIDO2 Demo](https://github.com/abergs/fido2-net-lib) ⭐ 1,452 | 🐛 20 | 🌐 C# | 📅 2026-09-21 - A working implementation library + demo for FIDO2 and WebAuthn using .NET <https://fido2-net-lib.passwordless.dev/>.
...
* `FIDO CONFORMANT` [MasterKale: @simplewebauthn/server](https://github.com/MasterKale/SimpleWebAuthn) ⭐ 2,352 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-13 - WebAuthn, Simplified. A TypeScript-first Node.js library for simpler WebAuthn integration. Supports use in TypeScript and JavaScript projects. Partner library to the front end **@simplewebauthn/browser** (see [Client Libs](#client-libs)).
* `FIDO CONFORMANT` [Anders Åberg: .NET library for FIDO2](https://github.com/abergs/fido2-net-lib) ⭐ 1,452 | 🐛 20 | 🌐 C# | 📅 2026-09-21 - A working implementation library + demo for fido2 and WebAuthn using .NET.
* `FIDO CONFORMANT` [WebAuthn Go library](https://github.com/go-webauthn/webauthn) ⭐ 1,337 | 🐛 7 | 🌐 Go | 📅 2026-09-19 - WebAuthn library written in Go (replaces the archived and deprecated [DUO: WebAuthn Go library](https://github.com/duo-labs/webauthn) ⚠️ Archived).
...
* [kanidm: webauthn-rs](https://github.com/kanidm/webauthn-rs) ⭐ 709 | 🐛 33 | 🌐 Rust | 📅 2026-09-22 - An implementation of webauthn components for Rustlang servers.
...
* [Yubico: Java WebAuthn Server](https://github.com/Yubico/java-webauthn-server) ⭐ 563 | 🐛 21 | 🌐 Scala | 📅 2026-09-22 - Server-side Web Authentication library for Java.
...
* `FIDO CONFORMANT` [uzyn: Passcay](https://github.com/uzyn/passcay) ⭐ 40 | 🐛 0 | 🌐 Zig | 📅 2026-06-23 - Passkey/WebAuthn library for Zig.
...
* [Firstyear: WebAuthn-RS](https://github.com/Firstyear/webauthn-rs) ⭐ 9 | 🐛 0 | 📅 2026-09-22 - An implementation of Passkeys and Webauthn components for Rust web servers.

## Client Libraries

* [MasterKale: @simplewebauthn/browser](https://github.com/MasterKale/SimpleWebAuthn/tree/master/packages/browser) ⭐ 2,352 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-13 - WebAuthn, Simplified. A TypeScript-first browser library for simpler WebAuthn integration. Supports use in TypeScript and JavaScript projects. Partner library to the back end **@simplewebauthn/server** (see [Server Libs](#server-libs)). Also works with Duo's py\_webauthn.
* [Yubico: libfido2](https://github.com/Yubico/libfido2) ⭐ 736 | 🐛 19 | 🌐 C | 📅 2026-08-18 - C client library and command-line tools to communicate with a FIDO device over USB, and to verify attestation and assertion signatures.
...
* [Corbado: flutter-passkeys](https://github.com/corbado/flutter-passkeys/) ⭐ 187 | 🐛 3 | 🌐 Dart | 📅 2026-09-17 - Flutter package to provide passkey authentication for iOS and Android apps.
* [Yubico: Mobile Android SDK (YubiKit)](https://github.com/Yubico/yubikit-android) ⭐ 158 | 🐛 18 | 🌐 Java | 📅 2026-09-22 - YubiKit is an Android library provided by Yubico to interact with YubiKeys on Android devices. Works with other FIDO2 devices as well.
...
* [Firstyear: webauthn-authenticator-rs](https://github.com/Firstyear/webauthn-rs) ⭐ 9 | 🐛 0 | 📅 2026-09-22 - Rust library for interacting with Security Keys, based on authenticator-rs, but with extensions to support CTAP2.1 and NFC.

## Software Authenticators

* [Pol Henarejos: pico-fido](https://github.com/polhenarejos/pico-fido) ⭐ 1,515 | 🐛 62 | 🌐 C | 📅 2026-09-20 - This project transforms your Raspberry Pi Pico into an integrated FIDO Passkey, functioning like a standard USB Passkey for authentication
* [bulwarkid: virtual-fido](https://github.com/bulwarkid/virtual-fido) ⭐ 1,403 | 🐛 36 | 🌐 C | 📅 2024-08-01 - virtual-fido is an Golang based commandline application which emulates an USB security token. This can also be used as a library.
...
* `FIDO CONFORMANT` [TheMaxMur: RS-Key](https://github.com/TheMaxMur/RS-Key) ⭐ 514 | 🐛 11 | 🌐 Rust | 📅 2026-09-20 - FIDO2/WebAuthn and U2F security-key firmware for the RP2350, written in Rust with reproducible builds; also implements OpenPGP, PIV and OATH.
...
* [Firstyear: webauthn-authenticator-rs](https://github.com/Firstyear/webauthn-rs) ⭐ 9 | 🐛 0 | 📅 2026-09-22 - Contains a software webauthn token with ephemeral attestation CA allowing richer testing of device policies.
...
* [Yubico Labs: Securing a Website with Passwordless Authentication](https://github.com/YubicoLabs/java-webauthn-passwordless-workshop) ⭐ 26 | 🐛 5 | 🌐 JavaScript | 📅 2023-12-05 - Yubico java discoverable credentials workshop.
...
* [WebAuthn Wiki](https://github.com/w3c/webauthn/wiki) ⭐ 1,463 | 🐛 111 | 🌐 Bikeshed | 📅 2026-09-18 - WebAuthn API spec official explainers and wiki
